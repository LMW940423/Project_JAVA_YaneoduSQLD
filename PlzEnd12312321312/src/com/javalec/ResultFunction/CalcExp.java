...
public class CalcExp {
	...
	public double CalcExpDown() { // 오답이 더 많을 경우!
		System.out.println("calcexpdown countIncorrect : " + countInCorrect);
...
//		new LevelBean(Integer.parseInt(arrayList.get(0)), Double.parseDouble(arrayList.get(1)));
