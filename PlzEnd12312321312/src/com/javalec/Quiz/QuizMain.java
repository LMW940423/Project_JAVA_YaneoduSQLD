...
//				endAction();
	...
	private TextArea getTaQuiz() {
		if (taQuiz == null) {
			...
			taQuiz.setBounds(10, 35, 470, 179);
		}
		return taQuiz;
	}
	...
	private TextArea getTxSolve() {
		if (txSolve == null) {
			...
			txSolve.setBounds(10, 334, 470, 199);
		}
		return txSolve;
	}
	private JLabel getLbSolve() {
		if (lbSolve == null) {
			...
			lbSolve.setBounds(20, 312, 61, 16);
		}
		return lbSolve;
	}
	private JButton getBtnNext() {
		if (btnNext == null) {
			...
			btnNext.setBounds(363, 296, 117, 29);
		}
		return btnNext;
	}
	...
	private JButton getBtnOK() {
		if (btnOK == null) {
			...
			btnOK.setBounds(363, 296, 117, 29);
		}
		return btnOK;
	}
	...
	private JLabel getLabelOvertime() {
		if (labelOvertime == null) {
			...
			labelOvertime.setBounds(336, 6, 61, 16);
		}
	...
	private JLabel getTimerLabel() {
		if (timerLabel == null) {
			...
			timerLabel.setBounds(396, 6, 84, 16);
		}
		return timerLabel;
	}
	public void Timer() {
