...
import com.javalec.LevelT.LevelTableAction;
...
public class ResultMain extends JDialog {
	...
	public ResultMain() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
				...
				if(shareVar.wrongNoteSwitch1 == 1) {
					ShowAll();
		...
		contentPanel.add(getBtnInCorrectNote());
		{
			...
			menuItem_Exit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					int choice = JOptionPane.showConfirmDialog(null, "정말 종료하시겠습니까?", "종료", JOptionPane.YES_NO_OPTION);
	...
	private JLabel getLblBadge() {
		if (lblBadge == null) {
			...
			lblBadge.setBounds(275, 36, 65, 90);
		}
		return lblBadge;
	}
	private JLabel getLblUSERLEVEL() {
		if (lblUSERLEVEL == null) {
			...
			lblUSERLEVEL.setForeground(new Color(0, 0, 51));
			lblUSERLEVEL.setFont(new Font("Dialog", Font.BOLD, 60));
			lblUSERLEVEL.setBounds(357, 15, 192, 130);
		}
		return lblUSERLEVEL;
	}
	private JLabel getLblSection() {
		if (lblSection == null) {
			...
			lblSection.setFont(new Font("Dialog", Font.BOLD, 23));
			lblSection.setBounds(115, 160, 573, 48);
		}
		return lblSection;
	}
	private JLabel getLblCorrect() {
		if (lblCorrect == null) {
			...
			lblCorrect.setBounds(175, 230, 131, 48);
		}
		return lblCorrect;
	}
	private JTextField getTfCorrect() {
		if (tfCorrect == null) {
			...
			tfCorrect.setBounds(343, 230, 244, 48);
		}
		return tfCorrect;
	}
	private JLabel getLblInCorrect() {
		if (lblInCorrect == null) {
			...
			lblInCorrect.setBounds(175, 316, 131, 48);
		}
		return lblInCorrect;
	}
	private JTextField getTfIncorrect() {
		if (tfIncorrect == null) {
			...
			tfIncorrect.setBounds(343, 316, 244, 48);
		}
		return tfIncorrect;
	}
	...
	private JButton getBtnReGame() {
		if (btnReGame == null) {
			...
			btnReGame.setFont(new Font("Dialog", Font.BOLD, 30));
			btnReGame.setBackground(new Color(102, 204, 255));
			btnReGame.setBounds(145, 503, 187, 60);
		}
		return btnReGame;
	}
	private JButton getBtnInCorrectNote() {
		if (btnInCorrectNote == null) {
			...
			btnInCorrectNote.setFont(new Font("Dialog", Font.BOLD, 30));
			btnInCorrectNote.setBackground(new Color(102, 204, 255));
			btnInCorrectNote.setBounds(431, 503, 187, 60);
		}
...
//		infoToLevelT.InsertInfo();
	...
	private JMenu getMenu_WrongNote() {
		if (menu_WrongNote == null) {
			...
			menu_WrongNote.add(getMenuItem_1_3());
		}
		return menu_WrongNote;
	}
	private JMenuItem getMenuItem_1_3() {
		if (menuItem_1 == null) {
			menuItem_1 = new JMenuItem("오답노트");
