...
public class ChatMain extends JDialog {
	...
	public ChatMain() {
		...
		btnNewButton.setBounds(31, 433, 125, 31);
	...
	public JTextField getTfChat() {
		if (tfChat == null) {
			...
			tfChat.setBounds(31, 392, 520, 26);
	...
	public JButton getBtnInsert() {
		if (btnInsert == null) {
			...
			btnInsert.setBounds(568, 391, 117, 29);
		}
		return btnInsert;
	}
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(0, 19, 815, 328);
...
//			System.out.println(arrayList.get(i).chattext);
//			System.out.println(arrayList.get(i).chatdatetime);
//		}
//		
