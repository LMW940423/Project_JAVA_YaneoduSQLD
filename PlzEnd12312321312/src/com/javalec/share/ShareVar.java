...
public class ShareVar {
	...
	public static final String url_mysql = "jdbc:mysql://127.0.0.1/yaneodusqld?serverTimezone=UTC&characterEncoding=utf8&useSSL=FALSE";
	...
	public static int wrongNoteSwitch1 = 0;
	public ShareVar() {
		System.out.println("rightScore : " + rightScore);
		System.out.println("wrongScore : " + wrongScore);
